...
import com.example.sslab.samplegroupapplication.widget.DilatingDotsProgressBar;

public class DilatingDotActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener{

    public final static String TAG = DilatingDotActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dilating_dot);

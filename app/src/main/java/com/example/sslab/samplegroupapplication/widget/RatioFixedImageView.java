 ...
 *
 */
public class RatioFixedImageView extends ImageView {
    ...
    public RatioFixedImageView( Context context, AttributeSet attrs, int defStyle ) {
        super(context, attrs, defStyle);
        init();
    }

    public RatioFixedImageView( Context context, AttributeSet attrs ) {
        super(context, attrs);
        init();
    }
